...
![Class distribution](figures/classDistr.png)
...
![Boxplot of Elevation by class](figures/boxplots/boxplot_Elevation.png)
...
![Boxplot of Elev_minus_VDH by class](figures/boxplots/boxplot_Elev_minus_VDH.png)
![Boxplot of Elev_plus_VDH by class](figures/boxplots/boxplot_Elev_plus_VDH.png)
...
![Boxplot of Horizontal_Distance_To_Roadways by class](figures/boxplots/boxplot_Horizontal_Distance_To_Roadways.png)
...
![Boxplot of Horizontal_Distance_To_Fire_Points by class](figures/boxplots/boxplot_Horizontal_Distance_To_Fire_Points.png)
...
![Boxplot of Horizontal_Distance_To_Hydrology by class](figures/boxplots/boxplot_Horizontal_Distance_To_Hydrology.png)
![Boxplot of Vertical_Distance_To_Hydrology by class](figures/boxplots/boxplot_Vertical_Distance_To_Hydrology.png)
![Boxplot of Distance_To_Hydrology by class](figures/boxplots/boxplot_Distance_To_Hydrology.png)
...
![Boxplot of Slope by class](figures/boxplots/boxplot_Slope.png)
...
![Boxplot of Hillshade_9am by class](figures/boxplots/boxplot_Hillshade_9am.png)
![Boxplot of Hillshade_Noon by class](figures/boxplots/boxplot_Hillshade_Noon.png)
![Boxplot of Hillshade_3pm by class](figures/boxplots/boxplot_Hillshade_3pm.png)
...
![Boxplot of Aspect by class](figures/boxplots/boxplot_Aspect.png)
...
![Class composition by wilderness area](figures/distr_wilderness.png)

![Elevation distribution by wilderness area](figures/elevation_per_wilderness.png)
...
![Soil type composition by cover type](figures/soiltype_per_covertype.png)
![Soil type distribution](figures/distr_soiltype.png)
...
![Correlation matrix](figures/heatMap.png)
...
![Elbow method for K-Means](figures/elbow_kmeans.png)
...
![Real classes vs K-Means clusters in PCA space](figures/KMeans_vs_PCA.png)
...
![Model comparison: weighted F1 vs macro F1](figures/model_comparison.png)
...
![Per-class recall on the test set, all models](figures/per_class_recall_heatmap.png)
![Per-class precision on the test set, all models](figures/per_class_precision_heatmap.png)
...
![Confusion matrix — Bagging Classifier](figures/cm_Bagging_Classifier.png)
![One-vs-Rest ROC curve — Bagging Classifier](figures/curves/roc_Bagging_Classifier.png)
![Precision-Recall curves — Bagging Classifier](figures/curves/pr_Bagging_Classifier.png)
...
![Confusion matrix — Random Forest](figures/cm_RandomForest.png)
![One-vs-Rest ROC curve — Random Forest](figures/curves/roc_RandomForest.png)
![Precision-Recall curves — Random Forest](figures/curves/pr_RandomForest.png)
...
![Confusion matrix — KNN](figures/cm_KNN.png)
![One-vs-Rest ROC curve — KNN](figures/curves/roc_KNN.png)
![Precision-Recall curves — KNN](figures/curves/pr_KNN.png)
...
![Confusion matrix — Gradient Boosting](figures/cm_GradientBoosting.png)
![One-vs-Rest ROC curve — Gradient Boosting](figures/curves/roc_GradientBoosting.png)
![Precision-Recall curves — Gradient Boosting](figures/curves/pr_GradientBoosting.png)
...
![Confusion matrix — Decision Tree Pruned](figures/cm_DecisionTree_Pruned.png)
![One-vs-Rest ROC curve — Decision Tree Pruned](figures/curves/roc_DecisionTree_Pruned.png)
...
![One-vs-Rest ROC curve — LightGBM](figures/curves/roc_LightGBM.png)
![Precision-Recall curves — LightGBM](figures/curves/pr_LightGBM.png)
...
![One-vs-Rest ROC curve — XGBoost](figures/curves/roc_XGBoost.png)
...
![Confusion matrix — MLP NeuralNet](figures/cm_MLP_NeuralNet.png)
![One-vs-Rest ROC curve — MLP NeuralNet](figures/curves/roc_MLP_NeuralNet.png)
...
![Confusion matrix — SVM RBF](figures/cm_SVM_RBF.png)
...
![Confusion matrix — Logistic Splines](figures/cm_Logistic_Splines.png)
![One-vs-Rest ROC curve — Logistic Splines](figures/curves/roc_Logistic_Splines.png)
...
![Confusion matrix — Logistic Reg](figures/cm_Logistic_Reg.png)
![One-vs-Rest ROC curve — Logistic Reg](figures/curves/roc_Logistic_Reg.png)
...
![Confusion matrix — LR + PCA](figures/cm_LR_PCA.png)
![One-vs-Rest ROC curve — LR + PCA](figures/curves/roc_LR_PCA.png)
...
![Confusion matrix — QDA](figures/cm_QDA.png)
![One-vs-Rest ROC curve — QDA](figures/curves/roc_QDA.png)
...
![Confusion matrix — LDA](figures/cm_LDA.png)
![One-vs-Rest ROC curve — LDA](figures/curves/roc_LDA.png)
...
![Confusion matrix — AdaBoost](figures/cm_AdaBoost.png)
![One-vs-Rest ROC curve — AdaBoost](figures/curves/roc_AdaBoost.png)
...
![Confusion matrix — Naive Bayes](figures/cm_NaiveBayes.png)
![One-vs-Rest ROC curve — Naive Bayes](figures/curves/roc_NaiveBayes.png)
