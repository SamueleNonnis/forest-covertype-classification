...
![Distribuzione delle classi](figures/classDistr.png)
...
![Boxplot di Elevation per classe](figures/boxplots/boxplot_Elevation.png)
...
![Boxplot di Elev_minus_VDH per classe](figures/boxplots/boxplot_Elev_minus_VDH.png)
![Boxplot di Elev_plus_VDH per classe](figures/boxplots/boxplot_Elev_plus_VDH.png)
...
![Boxplot di Horizontal_Distance_To_Roadways per classe](figures/boxplots/boxplot_Horizontal_Distance_To_Roadways.png)
...
![Boxplot di Horizontal_Distance_To_Fire_Points per classe](figures/boxplots/boxplot_Horizontal_Distance_To_Fire_Points.png)
...
![Boxplot di Horizontal_Distance_To_Hydrology per classe](figures/boxplots/boxplot_Horizontal_Distance_To_Hydrology.png)
![Boxplot di Vertical_Distance_To_Hydrology per classe](figures/boxplots/boxplot_Vertical_Distance_To_Hydrology.png)
![Boxplot di Distance_To_Hydrology per classe](figures/boxplots/boxplot_Distance_To_Hydrology.png)
...
![Boxplot di Slope per classe](figures/boxplots/boxplot_Slope.png)
...
![Boxplot di Hillshade_9am per classe](figures/boxplots/boxplot_Hillshade_9am.png)
![Boxplot di Hillshade_Noon per classe](figures/boxplots/boxplot_Hillshade_Noon.png)
![Boxplot di Hillshade_3pm per classe](figures/boxplots/boxplot_Hillshade_3pm.png)
...
![Boxplot di Aspect per classe](figures/boxplots/boxplot_Aspect.png)
...
![Composizione delle classi per area wilderness](figures/distr_wilderness.png)

![Distribuzione dell'altitudine per area wilderness](figures/elevation_per_wilderness.png)
...
![Composizione dei tipi di suolo per classe](figures/soiltype_per_covertype.png)
![Distribuzione dei tipi di suolo](figures/distr_soiltype.png)
...
![Matrice di correlazione](figures/heatMap.png)
...
![Metodo del gomito per K-Means](figures/elbow_kmeans.png)
...
![Classi reali e cluster K-Means nello spazio PCA](figures/KMeans_vs_PCA.png)
...
![Confronto dei modelli: F1 pesato e F1 macro](figures/model_comparison.png)
...
![Recall per classe sul test set, tutti i modelli](figures/per_class_recall_heatmap.png)
![Precision per classe sul test set, tutti i modelli](figures/per_class_precision_heatmap.png)
...
![Matrice di confusione — Bagging Classifier](figures/cm_Bagging_Classifier.png)
![Curva ROC One-vs-Rest — Bagging Classifier](figures/curves/roc_Bagging_Classifier.png)
![Curve Precision-Recall — Bagging Classifier](figures/curves/pr_Bagging_Classifier.png)
...
![Matrice di confusione — Random Forest](figures/cm_RandomForest.png)
![Curva ROC One-vs-Rest — Random Forest](figures/curves/roc_RandomForest.png)
![Curve Precision-Recall — Random Forest](figures/curves/pr_RandomForest.png)
...
![Matrice di confusione — KNN](figures/cm_KNN.png)
![Curva ROC One-vs-Rest — KNN](figures/curves/roc_KNN.png)
![Curve Precision-Recall — KNN](figures/curves/pr_KNN.png)
...
![Matrice di confusione — Gradient Boosting](figures/cm_GradientBoosting.png)
![Curva ROC One-vs-Rest — Gradient Boosting](figures/curves/roc_GradientBoosting.png)
![Curve Precision-Recall — Gradient Boosting](figures/curves/pr_GradientBoosting.png)
...
![Matrice di confusione — Decision Tree Pruned](figures/cm_DecisionTree_Pruned.png)
![Curva ROC One-vs-Rest — Decision Tree Pruned](figures/curves/roc_DecisionTree_Pruned.png)
...
![Matrice di confusione — LightGBM](figures/cm_LightGBM.png)
![Curva ROC One-vs-Rest — LightGBM](figures/curves/roc_LightGBM.png)
![Curve Precision-Recall — LightGBM](figures/curves/pr_LightGBM.png)
...
![Matrice di confusione — XGBoost](figures/cm_XGBoost.png)
![Curva ROC One-vs-Rest — XGBoost](figures/curves/roc_XGBoost.png)
...
![Matrice di confusione — MLP NeuralNet](figures/cm_MLP_NeuralNet.png)
![Curva ROC One-vs-Rest — MLP NeuralNet](figures/curves/roc_MLP_NeuralNet.png)
...
![Matrice di confusione — SVM RBF](figures/cm_SVM_RBF.png)
...
![Matrice di confusione — Logistic Splines](figures/cm_Logistic_Splines.png)
![Curva ROC One-vs-Rest — Logistic Splines](figures/curves/roc_Logistic_Splines.png)
...
![Matrice di confusione — Logistic Reg](figures/cm_Logistic_Reg.png)
![Curva ROC One-vs-Rest — Logistic Reg](figures/curves/roc_Logistic_Reg.png)
...
![Matrice di confusione — LR + PCA](figures/cm_LR_PCA.png)
![Curva ROC One-vs-Rest — LR + PCA](figures/curves/roc_LR_PCA.png)
...
![Matrice di confusione — QDA](figures/cm_QDA.png)
![Curva ROC One-vs-Rest — QDA](figures/curves/roc_QDA.png)
...
![Matrice di confusione — LDA](figures/cm_LDA.png)
![Curva ROC One-vs-Rest — LDA](figures/curves/roc_LDA.png)
...
![Matrice di confusione — AdaBoost](figures/cm_AdaBoost.png)
![Curva ROC One-vs-Rest — AdaBoost](figures/curves/roc_AdaBoost.png)
...
![Matrice di confusione — Naive Bayes](figures/cm_NaiveBayes.png)
![Curva ROC One-vs-Rest — Naive Bayes](figures/curves/roc_NaiveBayes.png)
